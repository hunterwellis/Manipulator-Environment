...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'dev/thesis',
        'env/src/arm_moveit_config/config'
    )
    install_config_path = os.path.join(
        home,
        'dev/thesis',
        'env/install/arm_moveit_config/share/arm_moveit_config/config'
    )
 
    # Read from source template
    template_path = os.path.join(src_config_path, 'ros2_ctrls_template.yaml')
