...
def generate_launch_description():
    ...
    gazebo_resource_path = SetEnvironmentVariable(
        ...
        value=[
            os.path.join(arm_sim_path, 'worlds'), ':' +
            str(Path(arm_description_path).parent.resolve())
            ]
        )
    ...
    rviz_config_file = os.path.join(arm_description_path, 'config', 'arm_robot_config.rviz')
